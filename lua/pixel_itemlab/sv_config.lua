...
PIXEL.ItemLab.Recipe("armor25", 30, 50, 1, nil, "hook", "hook", "cactus")
PIXEL.ItemLab.Recipe("armor50", 45, 100, 1, nil, "hook", "hook", "hook")

PIXEL.ItemLab.Recipe("pixel_armour_charger", 45, 100, 1, nil, "sign", "sign", "hook")
...
PIXEL.ItemLab.Recipe("pixel_armour_vip_charger", 45, 100, 1, PIXEL.CustomChecks.VIP, "sign", "hook", "hook")
